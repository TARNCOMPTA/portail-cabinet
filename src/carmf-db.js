// Base SQLite CARMF : un client = un identifiant CARMF (identifiant + mot de passe
// chiffre). Fichier SEPARE (carmf.db). Reutilise le chiffrement du portail (data/secret.key).
// Meme modele que CARPIMKO : connexion par client (pas de tiers declarant).
...
const db = new DatabaseSync(resolve(DATA_DIR, 'carmf.db'));
